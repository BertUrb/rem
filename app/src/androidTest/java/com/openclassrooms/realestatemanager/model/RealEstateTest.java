...
public class RealEstateTest extends TestCase {
    ...
    public void testFromContentValues() {
        ...
        values.put("mID", 12345L);
        values.put("mName", "Beautiful House");
        values.put("mJsonPoint", "{latitude: 123, longitude: 456}");
        values.put("mRegion", "City");
        values.put("mLocation", "123 Street");
        values.put("mDescription", "Spacious and modern house");
        values.put("mFeaturedMediaUrl", "http://example.com/image.jpg");
        values.put("mAgentName", "Agent Smith");
        values.put("mPrice", 200000);
        values.put("mSurface", 150);
        values.put("mRooms", 5);
        values.put("mBathrooms", 2);
        values.put("mBedrooms", 3);
